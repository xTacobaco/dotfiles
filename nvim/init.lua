...
vim.pack.add({
	...
	{ src = 'https://github.com/echasnovski/mini.ai' },          -- more text-objects
	{ src = 'https://github.com/echasnovski/mini.pick' },        -- hmm still evaluating this one
	{ src = 'https://github.com/xTacobaco/llmao.nvim' }	     -- sick llm tool idk, just testing
})
...
require('llmao.nvim').setup({ api_key = os.getenv "CLAUDE_API_KEY" })
